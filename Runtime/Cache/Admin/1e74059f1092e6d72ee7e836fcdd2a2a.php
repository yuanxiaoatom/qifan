...
<div class="tab-wrap">
    ...
    <form name='form1' action="/admin.php?s=/Think/louyuadd" method = 'post' enctype="multipart/form-data">
    	<table width='100%' cellpadding = '10'>
    		...
    		<tr>
    			<td>装修</td>
    			<td>
	    			<input type="text" name="zhuangxiu" value="" />
    			</td>
    		</tr>
    		...
    		<tr>
    			<td>楼层</td>
    			<td>
	    			<input type="text" name="louceng" value="" />
    			</td>
    		</tr>
    		...
    		<tr>
    			<td>配套</td>
    			<td>
	    			<input type="text" name="peitao" value="" />
    			</td>
    		</tr>
    		...
    		<tr>
    			<td>开发商</td>
    			<td>
	    			<input type="text" name="kaifashang" value="" />
    			</td>
    		</tr>
    		...
    		<tr>
    			<td>联系电话</td>
    			<td>
	    			<input type="text" name="lianxidianhua" value="" />
    			</td>
    		</tr>
    		...
    		<tr>
    			<td>周边配套</td>
    			<td>
	    			<textarea id="zhoubianpeitao" name="zhoubianpeitao" style="height:180px; width:100%"> </textarea>
    			</td>
    		</tr>
    		...
    		<tr>
    			<td>地理位置</td>
    			<td>
	    			<textarea id="diliweizhi" name='diliweizhi' style="height:180px; width:100%"> </textarea>
    			</td>
    		</tr>
    	</table>
...
<script type="text/javascript">
    ...
    var zc = UM.getEditor('zhoubianpeitao');
    var zc = UM.getEditor('diliweizhi');
